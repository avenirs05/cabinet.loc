		...
		<div class="col">
			<form class="fields-content">
				...
				<div class="form-group">
				  ...
				  <input id="date-exp-owner" type="text" class="form-control" placeholder="" value="2018-" required>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
				  ...
				  <input id="rep-email-exp-owner" type="text" class="form-control" placeholder="" required>
				</div>
				<div class="form-group">
