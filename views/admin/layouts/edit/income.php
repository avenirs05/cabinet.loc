  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Редактировать строку дохода <small>№</small> <span></span>?</h5>
...
<!--         <form class="fields-content">
          <div class="form-group">
            <label>Дата</label>
            <input id="income-date-edit" type="text" class="date-field form-control" placeholder="" required>
          </div>
          <div class="form-group">
            <label>Получил, €</label>
            <input id="income-got-edit" type="number" class="form-control" placeholder="" value="0" required>
          </div>
          <div class="form-group">
            <label>Отдал, €</label>
            <input id="income-gave-edit" type="number" class="form-control" placeholder="" value="0" required>
          </div>
